defmodule Conference.Routing.Recommendation do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Conference.Routing.Recommendation.remove_viewer(graph, "watcher")
      {graph, []}
  ...
  ## Examples
      ...
      iex> Conference.Routing.Recommendation.join_viewer(graph, "root", "new_member", [{"watcher1", 2}, {"watcher2", 1}])
      {:ok, graph, "watcher2"}
